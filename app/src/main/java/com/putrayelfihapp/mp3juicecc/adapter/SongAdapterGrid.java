...
import com.putrayelfihapp.mp3juicecc.databinding.ItemGridBinding;
...
public class SongAdapterGrid extends  RecyclerView.Adapter<RecyclerView.ViewHolder>  {

    List<SongModel> list= new ArrayList<>();
    Activity context;
    private OnitemClickListener mOnitemClickListener;

    public SongAdapterGrid(List<SongModel> list, Activity context) {
        this.list = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull  ViewGroup parent, int viewType) {
        return new MyViewHolder(ItemGridBinding.inflate(LayoutInflater.from(parent.getContext()),
                parent, false));
    }

    public  class MyViewHolder extends RecyclerView.ViewHolder{
        private ItemGridBinding item;
        public MyViewHolder(ItemGridBinding item) {
            super(item.getRoot());
            this.item=item;
        }
    }
