...
import com.putrayelfihapp.mp3juicecc.databinding.ItemCircleBinding;
...
public class SongAdapterCircle extends  RecyclerView.Adapter<RecyclerView.ViewHolder>  {

    List<SongModel> list= new ArrayList<>();
    Activity context;
    private OnitemClickListener mOnitemClickListener;

    public SongAdapterCircle(List<SongModel> list, Activity context) {
        this.list = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull  ViewGroup parent, int viewType) {
        return new MyViewHolder(ItemCircleBinding.inflate(LayoutInflater.from(parent.getContext()),
                parent, false));
    }

    public  class MyViewHolder extends RecyclerView.ViewHolder{
        private ItemCircleBinding item;
        public MyViewHolder(ItemCircleBinding item) {
            super(item.getRoot());
            this.item=item;
        }
    }
